...
const otherWeppResources = [
  ...
  //   label: "GeoWEPP",
  //   description:
  //     "The Geo-spatial interface for the Water Erosion Prediction Project (SUNY-Buffalo & Federal Agencies).",
  //   icon: "placeholder-model-icon.svg",
  //   href: "https://milford.nserl.purdue.edu/wepp/weppV1.html",
  //   external: true,
  // },
  ...
  //   label: "GeoWEPPer",
  //   description:
  //     "A prototype Perl script to allow you to use GeoWEPP partial results as inputs to WEPP FuMe or Disturbed WEPP (needs GeoWEPP and a Perl interpreter installed).",
  //   icon: "placeholder-model-icon.svg",
  //   href: "https://milford.nserl.purdue.edu/wepp/weppV1.html",
  //   external: true,
  // },
...
export { cligen, otherWeppResources };
