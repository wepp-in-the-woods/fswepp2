        ...
        <div className="w-full lg:w-auto lg:pr-6 relative">
          ...
          {openDropdown === 'predictionModels' && (
            ...
            <div className="list1 p-2 border-b border-gray-200 text-l lg:border-none">
              <div className="text-m p-2 border-b border-gray-200 font-bold lg:border-none">Hillslope and Runoff</div>
              <a href="/list1-item1" className="block pl-4 py-2 whitespace-nowrap">WEPP: Road</a>
              <a href="/list1-item2" className="block pl-4 py-2 whitespace-nowrap">WEPP: Road Batch</a>
              <a href="/list1-item3" className="block pl-4 py-2 whitespace-nowrap">ERMiT</a>
              <a href="/list1-item4" className="block pl-4 py-2 whitespace-nowrap">ERMiT Batch</a>
              <a href="/list1-item5" className="block pl-4 py-2 whitespace-nowrap">Distributed WEPP</a>
              <a href="/list1-item6" className="block pl-4 py-2 flex items-center whitespace-nowrap">
                Distributed WEPP Batch
                <img src="/external-link.svg" alt="External Link" className="ml-2 h-4 w-4" />
              </a>
              <div className="text-m p-2 border-b border-gray-200 font-bold lg:border-none">Watershed</div>
              <a href="/list2-item1" className="block pl-4 py-2 whitespace-nowrap">Tahoe Basin Sediment Model</a>
              <a href="/list2-item2" className="block pl-4 py-2 flex items-center whitespace-nowrap">
                WEPPcloud
                <img src="/external-link.svg" alt="External Link" className="ml-2 h-4 w-4" />
              </a>
              <a href="/list2-item3" className="block pl-4 py-2 flex items-center whitespace-nowrap">
                Lake Tahoe WEPP Watershed GIS Interface
                <img src="/external-link.svg" alt="External Link" className="ml-2 h-4 w-4" />
              </a>
              <a href="/list2-item4" className="block pl-4 py-2 flex items-center whitespace-nowrap">
                QWEPP
                <img src="/external-link.svg" alt="External Link" className="ml-2 h-4 w-4" />
              </a>
              <a href="/list2-item5" className="block pl-4 py-2 flex items-center whitespace-nowrap">
          ...
          {openDropdown === 'tools' && (
            <div className="dropdown-content w-full flex flex-col lg:absolute lg:top-full lg:left-0 lg:w-auto lg:bg-white lg:shadow-lg lg:z-10 lg:flex-row lg:border-2 lg:min-w-max">
              <div className="list1 p-2 text-l lg:border-none">
                <div className="text-m p-2 font-bold lg:border-none">Cligen Resources</div>
                <a href="/rockclime" className="block pl-4 py-2 whitespace-nowrap">Rock CliMe</a>
                <a href="/list1-item2" className="block pl-4 py-2 whitespace-nowrap">CliGen Weather Generator</a>
                <a href="/list1-item3" className="block pl-4 py-2 whitespace-nowrap">Distributed WEPP</a>
                <a href="/list1-item4" className="block pl-4 py-2 whitespace-nowrap">ARS Water Database</a>
                <a href="/list1-item5" className="block pl-4 py-2 whitespace-nowrap">FuME (Fuel Management)</a>
                <div className="text-m p-2 font-bold lg:border-none">Other WEPP Resources</div>
                <a href="/list2-item1" className="block pl-4 py-2 whitespace-nowrap">Legacy MFSL WEPP Interfaces</a>
                <a href="/list2-item2" className="block pl-4 py-2 flex items-center whitespace-nowrap">
                  USDA ARS WEPP
                  <img src="/external-link.svg" alt="External Link" className="ml-2 h-4 w-4" />
                </a>
